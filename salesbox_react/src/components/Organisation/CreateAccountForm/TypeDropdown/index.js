...
const TypeDropdown = ({ handleSearch, types, isFetching, ...other }: PropsT) => {
  return (
    <Dropdown loading={isFetching} onSearchChange={handleSearch} fluid search selection options={types} {...other} />
  );
};
